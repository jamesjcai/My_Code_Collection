...
fname2 = 'figures/csDMD_p1000_T2_r21/csDMD_VORTdiagS.eps';
...
set(gcf,'Position',[100 100 150 130])
set(gcf,'PaperPositionMode','auto')
fname2 = 'figures/csDMD_p1000_T2_r21/csDMD_VORTcumsumdiagS.eps';
% print('-depsc2', '-loose', fname2);
...
%% COMPRESSED SENSING MODES FROM PHIY
for i=10:21
    for k=25:25:75
    ahat = cosamp(Theta,PhiY(:,i),k,10^-5,10);
    Y = ifft2(reshape(ahat,199,449));
    plotCylinderNoSave(real(Y));
    plotCylinderNoSave(imag(Y));
    end
end