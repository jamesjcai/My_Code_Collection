function spider_plot_groups(P, P_labels, axes_interval, grp, varargin)
...
if nargin<2
    P_labels = cell(num_points, 1);
    for ii = 1:num_points
        P_labels{ii} = sprintf('Label %i', ii);
    end
end

if nargin<3, axes_interval=4; end
if nargin<4, grp=ones(num_of_rows,1); end
...
for ii = 1:num_of_rows    
    ...
    if grp(ii)==1
        ...
        plot(x_circular, y_circular, 'color',[0 0 1 0.7]);
    else
        plot(x_circular, y_circular, 'color',[1 0 0 0.2]);
    end
end
